...
public class Mp4VideoUtil extends VideoUtil {
    //ffmpeg的安装位置
    String ffmpeg_path = "E:\\environment\\ffmpeg\\ffmpeg.exe";
    String video_path = "E:\\test\\1.wmv";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "E:\\test\\01\\";
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "E:/environment/ffmpeg/ffmpeg.exe";
        //源avi视频的路径
        String video_path = "E:/test/1.wmv";
        //转换后mp4文件的名称
        String mp4_name = "test.mp4";
        //转换后mp4文件的路径
        String mp4_path = "E:/test/01/test.mp4";
        //创建工具类对象
